export const brandLogoSrc = '/img/koteka-digital-logo-jayapura-papua.png'

export const homeConsultationLink = `https://wa.me/6285210559404?text=${encodeURIComponent(
...
export const pricingComparisonRows = [
  {
    ...
    standard:
      'Company Profile, Portfolio Website, Website Sekolah, Website Organisasi / Yayasan',
